...
"templateMessage": {
  ...
  "hydratedTemplate": {
    "hydratedContentText": `Hi ${pushname} 👋,\n\n${jmn} - ${week} ${weton} - ${calender}`,
    "hydratedFooterText": `VANNESS BOTZ`,
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `WEBSITE VANNESS STORE`,
          "url": "https://vannessstore.xyz"
        },
        "index": 0
      }
    ]
